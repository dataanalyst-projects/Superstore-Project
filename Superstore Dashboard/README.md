...
## Learning
Looking at profit by year, region, and category together — instead of one at a time — showed that growth wasn't the same everywhere. Some regions and categories grew much faster than others, something a single overall total wouldn't have shown.
